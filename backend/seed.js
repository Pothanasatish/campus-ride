...
const seedData = async () => {
  try {
    ...
    console.log('[Seed Script] Connected to MongoDB Atlas / Local Database.');
    ...
    const [satish, ananya, vikram, admin] = users;
    ...
    console.log('[Seed Script] Sample dataset generated successfully!');
    console.log('-------------------------------------------------');
    console.log(' Credentials for Testing:');
    console.log(' Student Provider: satish.verma@srkr.edu.in  / password123');
    console.log(' Student Requester: ananya.rao@srkr.edu.in    / password123');
    console.log(' Admin User:        admin@campusride.edu      / password123');
    console.log('-------------------------------------------------');
